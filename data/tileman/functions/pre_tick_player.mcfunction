...
execute as @e[type=marker,tag=player2d,tag=currentPlayer] at @s unless entity @e[type=marker,tag=tileMarker,distance=..1] if loaded ~ ~ ~ run function tileman:tile_init/init_tile
