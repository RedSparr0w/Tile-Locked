...
execute unless score #cost5 TilemanData matches 5 scoreboard players set #cost5 TilemanData 5
execute unless score #ticks TilemanData matches 0.. scoreboard players set #ticks TilemanData 0
